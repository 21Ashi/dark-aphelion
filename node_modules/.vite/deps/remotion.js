...
var SequenceVisibilityToggleContext = import_react28.default.createContext({
  hidden: {},
  setHidden: () => {
    throw new Error("SequenceVisibilityToggle not initialized");
  }
});
var VisualModeOverridesContext = import_react28.default.createContext({
  dragOverrides: {},
  setDragOverrides: () => {
...
var SequenceManagerProvider = ({ children, visualModeEnabled }) => {
  ...
  const [hidden, setHidden] = (0, import_react28.useState)({});
  ...
  const [codeValues, setCodeValuesMapState] = (0, import_react28.useState)({});
  const setDragOverrides = (0, import_react28.useCallback)((sequenceId, key, value) => {
  ...
  const clearDragOverrides = (0, import_react28.useCallback)((sequenceId) => {
    setControlOverrides((prev) => {
      if (!prev[sequenceId]) {
        return prev;
      }
  ...
  const setCodeValues = (0, import_react28.useCallback)((sequenceId, values) => {
  ...
  const hiddenContext = (0, import_react28.useMemo)(() => {
    return {
      hidden,
      setHidden
    };
  }, [hidden]);
  const overrideContext = (0, import_react28.useMemo)(() => {
    return {
      visualModeEnabled,
      dragOverrides,
      setDragOverrides,
  ...
  return (0, import_jsx_runtime10.jsx)(SequenceManager.Provider, {
    value: sequenceContext,
    children: (0, import_jsx_runtime10.jsx)(SequenceVisibilityToggleContext.Provider, {
      value: hiddenContext,
      children: (0, import_jsx_runtime10.jsx)(VisualModeOverridesContext.Provider, {
...
var RegularSequenceRefForwardingFunction = ({
  ...
  const { hidden } = (0, import_react19.useContext)(SequenceVisibilityToggleContext);
  ...
  return (0, import_jsx_runtime11.jsx)(SequenceContext.Provider, {
    value: contextValue,
    children: content === null ? null : other.layout === "none" ? content : (0, import_jsx_runtime11.jsx)(AbsoluteFill, {
      ref,
      style: defaultStyle,
      className: other.className,
      children: content
...
var PremountedPostmountedSequenceRefForwardingFunction = (props, ref) => {
  ...
  return (0, import_jsx_runtime11.jsx)(Freeze, {
    frame: freezeFrame,
...
var SequenceRefForwardingFunction = (props, ref) => {
  ...
  if (props.layout !== "none" && !env.isRendering) {
    ...
    if (effectivePremountFor || props.postmountFor) {
      return (0, import_jsx_runtime11.jsx)(PremountedPostmountedSequence, {
        ref,
        ...props,
  ...
  return (0, import_jsx_runtime11.jsx)(RegularSequence, {
    ...props,
    ref
  });
};
var Sequence = (0, import_react19.forwardRef)(SequenceRefForwardingFunction);
...
var CanvasRefForwardingFunction = ({ width, height, fit, className, style }, ref) => {
  ...
  const draw = (0, import_react30.useCallback)((imageData) => {
    var _a;
...
var Canvas = import_react30.default.forwardRef(CanvasRefForwardingFunction);
var CACHE_SIZE = 5;
var getActualTime = ({
  loopBehavior,
  durationFound,
...
var AnimatedImage = (0, import_react29.forwardRef)(({
  src,
  width,
  height,
  onError,
  ...
  const mountState = (0, import_react29.useRef)({ isMounted: true });
  ...
  const [imageDecoder, setImageDecoder] = (0, import_react29.useState)(null);
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const [decodeHandle] = (0, import_react29.useState)(() => delayRender2(`Rendering <AnimatedImage/> with src="${resolvedSrc}"`));
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();
  const currentTime = frame / playbackRate / fps;
  const currentTimeRef = (0, import_react29.useRef)(currentTime);
  currentTimeRef.current = currentTime;
  const ref = (0, import_react29.useRef)(null);
  (0, import_react29.useImperativeHandle)(canvasRef, () => {
    var _a;
  ...
  const [initialLoopBehavior] = (0, import_react29.useState)(() => loopBehavior);
  (0, import_react29.useEffect)(() => {
...
var RenderAssetManager = (0, import_react32.createContext)({
  registerRenderAsset: () => {
    return;
  },
...
var RenderAssetManagerProvider = ({ children, collectAssets }) => {
  const [renderAssets, setRenderAssets] = (0, import_react32.useState)([]);
  const renderAssetsRef = (0, import_react32.useRef)([]);
  const registerRenderAsset = (0, import_react32.useCallback)((renderAsset) => {
    validateRenderAsset(renderAsset);
    renderAssetsRef.current = [...renderAssetsRef.current, renderAsset];
    setRenderAssets(renderAssetsRef.current);
  }, []);
  if (collectAssets) {
    (0, import_react32.useImperativeHandle)(collectAssets, () => {
      return {
        collectAssets: () => {
  ...
  const unregisterRenderAsset = (0, import_react32.useCallback)((id) => {
  ...
  return (0, import_jsx_runtime14.jsx)(RenderAssetManager.Provider, {
    value: contextValue,
    children
  });
};
...
var Artifact = ({ filename, content, downloadBehavior }) => {
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react31.useContext)(RenderAssetManager);
  const env = useRemotionEnvironment();
  const frame = useCurrentFrame();
  const [id] = (0, import_react31.useState)(() => {
...
var LoopContext = (0, import_react34.createContext)(null);
var useLoop = () => {
  return import_react34.default.useContext(LoopContext);
};
var Loop = ({ durationInFrames, times = Infinity, children, name, ...props }) => {
  ...
  const loopDisplay = (0, import_react34.useMemo)(() => {
    return {
  ...
  const loopContext = (0, import_react34.useMemo)(() => {
    return {
      iteration: Math.floor(currentFrame / durationInFrames),
      durationInFrames
    };
  }, [currentFrame, durationInFrames]);
  return (0, import_jsx_runtime15.jsx)(LoopContext.Provider, {
    value: loopContext,
    children: (0, import_jsx_runtime15.jsx)(Sequence, {
      durationInFrames,
      from,
      name: name ?? "<Loop>",
      _remotionInternalLoopDisplay: loopDisplay,
...
var PreloadContext = (0, import_react36.createContext)({});
var preloads = {};
var updaters = [];
...
var PrefetchProvider = ({ children }) => {
  const [_preloads, _setPreloads] = (0, import_react36.useState)(() => preloads);
  ...
  return (0, import_jsx_runtime16.jsx)(PreloadContext.Provider, {
    value: _preloads,
    children
  });
};
...
var usePreload = (src) => {
  const preloads2 = (0, import_react35.useContext)(PreloadContext);
...
var DurationsContext = (0, import_react37.createContext)({
  durations: {},
  setDurations: () => {
...
var DurationsContextProvider = ({ children }) => {
  const [durations, setDurations] = (0, import_react37.useReducer)(durationReducer, {});
  ...
  return (0, import_jsx_runtime17.jsx)(DurationsContext.Provider, {
    value,
    children
  });
};
...
var SharedAudioContext = (0, import_react40.createContext)(null);
var SharedAudioTagsContext = (0, import_react40.createContext)(null);
var SharedAudioContextProvider = ({ children, audioLatencyHint, audioEnabled }) => {
  ...
  const audioContextIsPlayingEventually = (0, import_react40.useRef)(false);
  const isResuming = (0, import_react40.useRef)(null);
  const audioSyncAnchor = (0, import_react40.useMemo)(() => ({ value: 0 }), []);
  const audioSyncAnchorListeners = (0, import_react40.useRef)([]);
  const audioSyncAnchorEmitter = (0, import_react40.useMemo)(() => {
    return {
      dispatch: (event) => {
  ...
  const prevEndTimes = (0, import_react40.useRef)({ scheduledEndTime: null, mediaEndTime: null });
  const nodesToResume = (0, import_react40.useRef)(/* @__PURE__ */ new Map());
  const unscheduleAudioNode = (0, import_react40.useCallback)((node) => {
    nodesToResume.current.delete(node);
  }, []);
  const scheduleAudioNode = (0, import_react40.useMemo)(() => {
    return ({
      node,
      mediaTimestamp,
      currentTime,
  ...
  const resume = (0, import_react40.useCallback)(() => {
    var _a, _b;
    if (!ctxAndGain) {
  ...
  const getIsResumingAudioContext = (0, import_react40.useCallback)(() => {
    return isResuming.current;
  }, []);
  const suspend = (0, import_react40.useCallback)(() => {
    if (!ctxAndGain) {
      return;
    }
    if (!audioContextIsPlayingEventually.current) {
  ...
  const audioContextValue = (0, import_react40.useMemo)(() => {
    return {
  ...
  return (0, import_jsx_runtime18.jsx)(SharedAudioContext.Provider, {
    value: audioContextValue,
    children
  });
};
var SharedAudioTagsContextProvider = ({ children, numberOfAudioTags }) => {
  const audios = (0, import_react40.useRef)([]);
  const [initialNumberOfAudioTags] = (0, import_react40.useState)(numberOfAudioTags);
  ...
  const env = useRemotionEnvironment();
  const audioCtx = (0, import_react40.useContext)(SharedAudioContext);
  const audioContext = (audioCtx == null ? void 0 : audioCtx.audioContext) ?? null;
  const resume = audioCtx == null ? void 0 : audioCtx.resume;
  const refs = (0, import_react40.useMemo)(() => {
    return new Array(numberOfAudioTags).fill(true).map(() => {
      const ref = (0, import_react40.createRef)();
      return {
        id: Math.random(),
        ref,
  ...
  const effectToUse = import_react40.default.useInsertionEffect ?? import_react40.default.useLayoutEffect;
  effectToUse(() => {
    return () => {
  ...
  const takenAudios = (0, import_react40.useRef)(new Array(numberOfAudioTags).fill(false));
  const rerenderAudios = (0, import_react40.useCallback)(() => {
    refs.forEach(({ ref, id }) => {
      var _a;
  ...
  const registerAudio = (0, import_react40.useCallback)((options) => {
    var _a, _b;
  ...
  const unregisterAudio = (0, import_react40.useCallback)((id) => {
    var _a;
    const cloned = [...takenAudios.current];
  ...
  const updateAudio = (0, import_react40.useCallback)(({
    aud,
    audioId,
    id,
    premounting,
  ...
  const playAllAudios = (0, import_react40.useCallback)(() => {
    refs.forEach((ref) => {
  ...
  const audioTagsValue = (0, import_react40.useMemo)(() => {
    return {
      registerAudio,
      unregisterAudio,
      updateAudio,
  ...
  return (0, import_jsx_runtime18.jsxs)(SharedAudioTagsContext.Provider, {
...
var useSharedAudio = ({
  ...
  const audioCtx = (0, import_react40.useContext)(SharedAudioContext);
  const tagsCtx = (0, import_react40.useContext)(SharedAudioTagsContext);
  const [elem] = (0, import_react40.useState)(() => {
    if (tagsCtx && tagsCtx.numberOfAudioTags > 0) {
      return tagsCtx.registerAudio({ aud, audioId, premounting, postmounting });
    }
    const el = import_react40.default.createRef();
...
var useAppendVideoFragment = ({
  ...
  const actualFromRef = (0, import_react42.useRef)(initialActualFrom);
  const actualDuration = (0, import_react42.useRef)(initialDuration);
  const actualSrc = (0, import_react42.useRef)(initialActualSrc);
...
var useVolume = ({
  ...
  var _a, _b, _c;
  const audioStuffRef = (0, import_react39.useRef)(null);
  const currentVolumeRef = (0, import_react39.useRef)(volume);
  currentVolumeRef.current = volume;
  const sharedAudioContext = (0, import_react39.useContext)(SharedAudioContext);
...
var useMediaStartsAt = () => {
  const parentSequence = (0, import_react44.useContext)(SequenceContext);
...
var useBasicMediaInTimeline = ({
  ...
  const startsAt = useMediaStartsAt();
  const parentSequence = (0, import_react43.useContext)(SequenceContext);
  const videoConfig = useVideoConfig();
  const [initialVolume] = (0, import_react43.useState)(() => volume);
  ...
  const volumes = (0, import_react43.useMemo)(() => {
    if (typeof volume === "number") {
      return volume;
    }
...
var useImageInTimeline = ({
  ...
  const parentSequence = (0, import_react43.useContext)(SequenceContext);
  const { registerSequence, unregisterSequence } = (0, import_react43.useContext)(SequenceManager);
...
var useBufferManager = (logLevel, mountTime) => {
  const [blocks, setBlocks] = (0, import_react48.useState)([]);
  const [onBufferingCallbacks, setOnBufferingCallbacks] = (0, import_react48.useState)([]);
  const [onResumeCallbacks, setOnResumeCallbacks] = (0, import_react48.useState)([]);
  const env = useRemotionEnvironment();
  const rendering = env.isRendering;
  const buffering = (0, import_react48.useRef)(false);
  const addBlock = (0, import_react48.useCallback)((block) => {
    if (rendering) {
      return {
        unblock: () => {
          return;
  ...
  const listenForBuffering = (0, import_react48.useCallback)((callback) => {
  ...
  const listenForResume = (0, import_react48.useCallback)((callback) => {
...
var BufferingContextReact = import_react48.default.createContext(null);
var BufferingProvider = ({ children }) => {
  const { logLevel, mountTime } = (0, import_react48.useContext)(LogLevelContext);
  const bufferManager = useBufferManager(logLevel ?? "info", mountTime);
  return (0, import_jsx_runtime19.jsx)(BufferingContextReact.Provider, {
    value: bufferManager,
    children
  });
};
var useIsPlayerBuffering = (bufferManager) => {
  const [isBuffering, setIsBuffering] = (0, import_react48.useState)(bufferManager.buffering.current);
  (0, import_react48.useEffect)(() => {
    const onBuffer = () => {
      setIsBuffering(true);
    };
...
var useBufferState = () => {
  const buffer = (0, import_react47.useContext)(BufferingContextReact);
...
var useBufferUntilFirstFrame = ({
  ...
  const bufferingRef = (0, import_react46.useRef)(false);
  const { delayPlayback } = useBufferState();
  const bufferUntilFirstFrame = (0, import_react46.useCallback)((requestedTime) => {
    var _a;
    if (mediaType !== "video") {
      return;
    }
...
var useCurrentTimeOfMediaTagWithUpdateTimeStamp = (mediaRef) => {
  var _a, _b;
  const lastUpdate = import_react49.default.useRef({
...
var useMediaBuffering = ({
  ...
  const [isBuffering, setIsBuffering] = (0, import_react50.useState)(false);
...
var useRequestVideoCallbackTime = ({
  ...
  const currentTime = (0, import_react51.useRef)(null);
...
var useMediaPlayback = ({
  ...
  const buffering = (0, import_react45.useContext)(BufferingContextReact);
  const { fps } = useVideoConfig();
  const mediaStartsAt = useMediaStartsAt();
  const lastSeekDueToShift = (0, import_react45.useRef)(null);
  const lastSeek = (0, import_react45.useRef)(null);
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  if (!buffering) {
    throw new Error("useMediaPlayback must be used inside a <BufferingContext>");
  }
  const isVariableFpsVideoMap = (0, import_react45.useRef)({});
  const onVariableFpsVideoDetected = (0, import_react45.useCallback)(() => {
    if (!src) {
      return;
    }
...
var MediaVolumeContext = (0, import_react53.createContext)({
  mediaMuted: false,
  mediaVolume: 1
});
var SetMediaVolumeContext = (0, import_react53.createContext)({
  setMediaMuted: () => {
    throw new Error("default");
  },
  setMediaVolume: () => {
...
var useMediaVolumeState = () => {
  const { mediaVolume } = (0, import_react53.useContext)(MediaVolumeContext);
  const { setMediaVolume } = (0, import_react53.useContext)(SetMediaVolumeContext);
  return (0, import_react53.useMemo)(() => {
    return [mediaVolume, setMediaVolume];
  }, [mediaVolume, setMediaVolume]);
};
var useMediaMutedState = () => {
  const { mediaMuted } = (0, import_react53.useContext)(MediaVolumeContext);
  const { setMediaMuted } = (0, import_react53.useContext)(SetMediaVolumeContext);
  return (0, import_react53.useMemo)(() => {
...
var AudioForDevelopmentForwardRefFunction = (props, ref) => {
  const [initialShouldPreMountAudioElements] = (0, import_react38.useState)(props.shouldPreMountAudioTags);
  ...
  const { hidden } = (0, import_react38.useContext)(SequenceVisibilityToggleContext);
  if (!src) {
    throw new TypeError("No 'src' was passed to <Html5Audio>.");
  }
  const preloadedSrc = usePreload(src);
  const sequenceContext = (0, import_react38.useContext)(SequenceContext);
  const [timelineId] = (0, import_react38.useState)(() => String(Math.random()));
  ...
  const propsToPass = (0, import_react38.useMemo)(() => {
    return {
  ...
  const id = (0, import_react38.useMemo)(() => `audio-${random(src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}-muted:${props.muted}-loop:${props.loop}`, [
    src,
  ...
  const effectToUse = import_react38.default.useInsertionEffect ?? import_react38.default.useLayoutEffect;
  effectToUse(() => {
    return () => {
      requestAnimationFrame(() => {
        cleanupOnMediaTagUnmount();
  ...
  const currentOnDurationCallback = (0, import_react38.useRef)(onDuration);
...
var AudioForPreview = (0, import_react38.forwardRef)(AudioForDevelopmentForwardRefFunction);
var AudioForRenderingRefForwardingFunction = (props, ref) => {
  const audioRef = (0, import_react54.useRef)(null);
  const {
    volume: volumeProp,
    playbackRate,
    allowAmplificationDuringRender,
  ...
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react54.useContext)(RenderAssetManager);
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const id = (0, import_react54.useMemo)(() => `audio-${random(props.src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    props.src,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
...
var AudioForRendering = (0, import_react54.forwardRef)(AudioForRenderingRefForwardingFunction);
var AudioRefForwardingFunction = (props, ref) => {
  const audioTagsContext = (0, import_react33.useContext)(SharedAudioTagsContext);
  const {
    startFrom,
    endAt,
    trimBefore,
  ...
  const { durations, setDurations } = (0, import_react33.useContext)(DurationsContext);
  if (typeof props.src !== "string") {
    throw new TypeError(`The \`<Html5Audio>\` tag requires a string for \`src\`, but got ${JSON.stringify(props.src)} instead.`);
  }
  const preloadedSrc = usePreload(props.src);
  const onError = (0, import_react33.useCallback)((e) => {
  ...
  const onDuration = (0, import_react33.useCallback)((src, durationInSeconds) => {
  ...
  if (loop && durationFetched !== void 0) {
    if (!Number.isFinite(durationFetched)) {
      return (0, import_jsx_runtime22.jsx)(Html5Audio, {
        ...propsOtherThanLoop,
        ref,
    ...
    return (0, import_jsx_runtime22.jsx)(Loop, {
      layout: "none",
      ...
      children: (0, import_jsx_runtime22.jsx)(Html5Audio, {
        ...propsOtherThanLoop,
        ref,
        _remotionInternalNativeLoopPassed: true
      })
  ...
  if (typeof trimBeforeValue !== "undefined" || typeof trimAfterValue !== "undefined") {
    return (0, import_jsx_runtime22.jsx)(Sequence, {
      layout: "none",
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime22.jsx)(AudioForRendering, {
      onDuration,
      ...props,
      ref,
  ...
  return (0, import_jsx_runtime22.jsx)(AudioForPreview, {
...
var Html5Audio = (0, import_react33.forwardRef)(AudioRefForwardingFunction);
...
var IFrameRefForwarding = ({
  ...
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const [handle] = (0, import_react55.useState)(() => delayRender2(`Loading <IFrame> with source ${props2.src}`, {
    retries: delayRenderRetries ?? void 0,
    timeoutInMilliseconds: delayRenderTimeoutInMilliseconds ?? void 0
  }));
  const didLoad = (0, import_react55.useCallback)((e) => {
    continueRender2(handle);
    onLoad == null ? void 0 : onLoad(e);
  }, [handle, onLoad, continueRender2]);
  const didGetError = (0, import_react55.useCallback)((e) => {
    continueRender2(handle);
    if (onError) {
      onError(e);
    } else {
...
var IFrame = (0, import_react55.forwardRef)(IFrameRefForwarding);
...
var useSchema = (schema, currentValue) => {
  const env = useRemotionEnvironment();
  const earlyReturn = (0, import_react58.useMemo)(() => {
  ...
  const [overrideId] = (0, import_react58.useState)(() => String(Math.random()));
  const {
    visualModeEnabled,
    dragOverrides: overrides,
    codeValues
  } = (0, import_react58.useContext)(VisualModeOverridesContext);
  const controls = (0, import_react58.useMemo)(() => {
...
var wrapInSchema = (Component, schema) => {
  ...
  const Wrapped = (0, import_react57.forwardRef)((props2, ref) => {
    const env = useRemotionEnvironment();
    if (!env.isStudio || env.isReadOnlyStudio || env.isRendering || !process.env.EXPERIMENTAL_VISUAL_MODE_ENABLED) {
      return import_react57.default.createElement(Component, {
        ...props2,
        controls: null,
        ref
      });
    }
    const schemaInput = (0, import_react57.useMemo)(() => {
      const input = {};
      for (const key of schemaKeys) {
...
var ImgInner = ({
  ...
  const imageRef = (0, import_react56.useRef)(null);
  const errors = (0, import_react56.useRef)({});
  const { delayPlayback } = useBufferState();
  const sequenceContext = (0, import_react56.useContext)(SequenceContext);
  const [timelineId] = (0, import_react56.useState)(() => String(Math.random()));
  if (!src) {
  ...
  const retryIn = (0, import_react56.useCallback)((timeout) => {
    if (!imageRef.current) {
      return;
    }
  ...
  const didGetError = (0, import_react56.useCallback)((e) => {
...
var compositionsRef = import_react60.default.createRef();
var CompositionManagerProvider = ({
  ...
  const [folders, setFolders] = (0, import_react61.useState)([]);
  const [canvasContent, setCanvasContent] = (0, import_react61.useState)(initialCanvasContent);
  const [compositions, setCompositions] = (0, import_react61.useState)(initialCompositions);
  const currentcompositionsRef = (0, import_react61.useRef)(compositions);
  const updateCompositions = (0, import_react61.useCallback)((updateComps) => {
  ...
  const registerComposition = (0, import_react61.useCallback)((comp) => {
  ...
  const unregisterComposition = (0, import_react61.useCallback)((id) => {
    setCompositions((comps) => {
      return comps.filter((c2) => c2.id !== id);
    });
  }, []);
  const registerFolder = (0, import_react61.useCallback)((name, parent, nonce) => {
  ...
  const unregisterFolder = (0, import_react61.useCallback)((name, parent) => {
    setFolders((prevFolders) => {
      return prevFolders.filter((p) => !(p.name === name && p.parent === parent));
    });
  }, []);
  (0, import_react61.useImperativeHandle)(compositionsRef, () => {
    return {
      getCompositions: () => currentcompositionsRef.current
    };
  }, []);
  const compositionManagerSetters = (0, import_react61.useMemo)(() => {
    return {
      registerComposition,
      unregisterComposition,
      registerFolder,
  ...
  const compositionManagerContextValue = (0, import_react61.useMemo)(() => {
    return {
      compositions,
      folders,
      currentCompositionMetadata,
...
var MaxMediaCacheSizeContext = import_react62.default.createContext(null);
var Root = null;
var listeners = [];
...
var MediaEnabledContext = (0, import_react64.createContext)(null);
var useVideoEnabled = () => {
  const context = (0, import_react64.useContext)(MediaEnabledContext);
  if (!context) {
...
var MediaEnabledProvider = ({
  ...
  const value = (0, import_react64.useMemo)(() => ({ videoEnabled, audioEnabled }), [videoEnabled, audioEnabled]);
  return (0, import_jsx_runtime26.jsx)(MediaEnabledContext.Provider, {
    value,
    children
  });
};
var RemotionRootContexts = ({
  ...
  const nonceContext = (0, import_react63.useMemo)(() => {
    let counter = 0;
    return {
      getNonce: () => counter++
    };
  }, []);
  const logging = (0, import_react63.useMemo)(() => {
    return { logLevel, mountTime: Date.now() };
  }, [logLevel]);
  return (0, import_jsx_runtime27.jsx)(LogLevelContext.Provider, {
    value: logging,
    children: (0, import_jsx_runtime27.jsx)(NonceContext.Provider, {
      value: nonceContext,
      children: (0, import_jsx_runtime27.jsx)(TimelineContextProvider, {
        frameState,
        children: (0, import_jsx_runtime27.jsx)(MediaEnabledProvider, {
          videoEnabled,
          audioEnabled,
          children: (0, import_jsx_runtime27.jsx)(EditorPropsProvider, {
            children: (0, import_jsx_runtime27.jsx)(PrefetchProvider, {
              children: (0, import_jsx_runtime27.jsx)(SequenceManagerProvider, {
                visualModeEnabled,
                children: (0, import_jsx_runtime27.jsx)(DurationsContextProvider, {
                  children: (0, import_jsx_runtime27.jsx)(BufferingProvider, {
                    children: (0, import_jsx_runtime27.jsx)(SharedAudioContextProvider, {
                      audioLatencyHint,
                      audioEnabled,
                      children: (0, import_jsx_runtime27.jsx)(SharedAudioTagsContextProvider, {
                        numberOfAudioTags,
                        children
                      })
                    })
...
var SequenceStackTracesUpdateContext = import_react65.default.createContext(() => {
});
var getEnvVariables = () => {
  if (getRemotionEnvironment().isRendering) {
...
var CurrentScaleContext = import_react66.default.createContext(null);
var PreviewSizeContext = (0, import_react66.createContext)({
  setSize: () => {
    return;
  },
...
var useCurrentScale = (options) => {
  const hasContext = import_react66.default.useContext(CurrentScaleContext);
  const zoomContext = import_react66.default.useContext(PreviewSizeContext);
...
var useSequenceControlOverride = (key) => {
  var _a;
  const seqContext = (0, import_react67.useContext)(SequenceContext);
  const { dragOverrides: overrides } = (0, import_react67.useContext)(VisualModeOverridesContext);
  if (!seqContext) {
    return;
  }
...
var OffthreadVideoForRendering = ({
  ...
  const id = (0, import_react69.useMemo)(() => `offthreadvideo-${random(src)}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    src,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
  ...
  const currentTime = (0, import_react69.useMemo)(() => {
  ...
  const actualSrc = (0, import_react69.useMemo)(() => {
  ...
  const [imageSrc, setImageSrc] = (0, import_react69.useState)(null);
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  ...
  const onErr = (0, import_react69.useCallback)(() => {
    if (onError) {
  ...
  const className = (0, import_react69.useMemo)(() => {
    return [OBJECTFIT_CONTAIN_CLASS_NAME, props2.className].filter(truthy).join(" ");
  }, [props2.className]);
  const onImageFrame = (0, import_react69.useCallback)((img) => {
    if (onVideoFrame) {
      onVideoFrame(img);
    }
  }, [onVideoFrame]);
...
var VideoForDevelopmentRefForwardingFunction = (props2, ref) => {
  const context = (0, import_react70.useContext)(SharedAudioContext);
  if (!context) {
    throw new Error("SharedAudioContext not found");
  }
  const videoRef = (0, import_react70.useRef)(null);
  const sharedSource = (0, import_react70.useMemo)(() => {
  ...
  const effectToUse = import_react70.default.useInsertionEffect ?? import_react70.default.useLayoutEffect;
  effectToUse(() => {
    return () => {
      requestAnimationFrame(() => {
  ...
  const parentSequence = (0, import_react70.useContext)(SequenceContext);
  const { hidden } = (0, import_react70.useContext)(SequenceVisibilityToggleContext);
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  const [timelineId] = (0, import_react70.useState)(() => String(Math.random()));
  const isSequenceHidden = hidden[timelineId] ?? false;
  ...
  (0, import_react70.useState)(() => playbackLogging({
    logLevel,
  ...
  const currentOnDurationCallback = (0, import_react70.useRef)(onDuration);
  currentOnDurationCallback.current = onDuration;
  ...
  const actualStyle = (0, import_react70.useMemo)(() => {
    return {
      ...style,
  ...
  return (0, import_jsx_runtime29.jsx)("video", {
    ref: videoRef,
    muted: muted || mediaMuted || isSequenceHidden || userPreferredVolume <= 0,
    playsInline: true,
    src: actualSrc,
...
var VideoForPreview = (0, import_react70.forwardRef)(VideoForDevelopmentRefForwardingFunction);
var InnerOffthreadVideo = (props2) => {
  ...
  const onDuration = (0, import_react68.useCallback)(() => {
    return;
  }, []);
  ...
  if (typeof trimBeforeValue !== "undefined" || typeof trimAfterValue !== "undefined") {
    return (0, import_jsx_runtime30.jsx)(Sequence, {
      ...
      durationInFrames: trimAfterValue,
      name,
      children: (0, import_jsx_runtime30.jsx)(InnerOffthreadVideo, {
        pauseWhenBuffering: pauseWhenBuffering ?? false,
        ...otherProps,
        trimAfter: void 0,
        name: void 0,
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime30.jsx)(OffthreadVideoForRendering, {
      pauseWhenBuffering: pauseWhenBuffering ?? false,
      ...otherProps,
      trimAfter: void 0,
      name: void 0,
  ...
  return (0, import_jsx_runtime30.jsx)(VideoForPreview, {
    _remotionInternalStack: stack ?? null,
    onDuration,
...
var OffthreadVideo = ({
  ...
  return (0, import_jsx_runtime30.jsx)(InnerOffthreadVideo, {
    acceptableTimeShiftInSeconds,
...
function useRemotionContexts() {
  const compositionManagerCtx = import_react72.default.useContext(CompositionManager);
  const timelineContext = import_react72.default.useContext(TimelineContext);
  const setTimelineContext = import_react72.default.useContext(SetTimelineContext);
  const sequenceContext = import_react72.default.useContext(SequenceContext);
  const nonceContext = import_react72.default.useContext(NonceContext);
  const canUseRemotionHooksContext = import_react72.default.useContext(CanUseRemotionHooks);
  const preloadContext = import_react72.default.useContext(PreloadContext);
  const resolveCompositionContext = import_react72.default.useContext(ResolveCompositionContext);
  const renderAssetManagerContext = import_react72.default.useContext(RenderAssetManager);
  const sequenceManagerContext = import_react72.default.useContext(SequenceManager);
  const bufferManagerContext = import_react72.default.useContext(BufferingContextReact);
  const logLevelContext = import_react72.default.useContext(LogLevelContext);
...
var RemotionContextProvider = (props2) => {
  ...
  return (0, import_jsx_runtime31.jsx)(LogLevelContext.Provider, {
    value: contexts.logLevelContext,
    children: (0, import_jsx_runtime31.jsx)(CanUseRemotionHooks.Provider, {
      value: contexts.canUseRemotionHooksContext,
      children: (0, import_jsx_runtime31.jsx)(NonceContext.Provider, {
        value: contexts.nonceContext,
        children: (0, import_jsx_runtime31.jsx)(PreloadContext.Provider, {
          value: contexts.preloadContext,
          children: (0, import_jsx_runtime31.jsx)(CompositionManager.Provider, {
            value: contexts.compositionManagerCtx,
            children: (0, import_jsx_runtime31.jsx)(SequenceManager.Provider, {
              value: contexts.sequenceManagerContext,
              children: (0, import_jsx_runtime31.jsx)(RenderAssetManager.Provider, {
                value: contexts.renderAssetManagerContext,
                children: (0, import_jsx_runtime31.jsx)(ResolveCompositionContext.Provider, {
                  value: contexts.resolveCompositionContext,
                  children: (0, import_jsx_runtime31.jsx)(TimelineContext.Provider, {
                    value: contexts.timelineContext,
                    children: (0, import_jsx_runtime31.jsx)(SetTimelineContext.Provider, {
                      value: contexts.setTimelineContext,
                      children: (0, import_jsx_runtime31.jsx)(SequenceContext.Provider, {
                        value: contexts.sequenceContext,
                        children: (0, import_jsx_runtime31.jsx)(BufferingContextReact.Provider, {
...
var compositionSelectorRef = (0, import_react59.createRef)();
var Internals = {
...
var flattenChildren = (children) => {
  ...
  return childrenArray.reduce((flatChildren, child) => {
    if (child.type === import_react74.default.Fragment) {
...
var IsInsideSeriesContext = (0, import_react75.createContext)(false);
var IsInsideSeriesContainer = ({ children }) => {
  return (0, import_jsx_runtime32.jsx)(IsInsideSeriesContext.Provider, {
    value: true,
    children
  });
};
...
var useRequireToBeInsideSeries = () => {
  const isInsideSeries = import_react75.default.useContext(IsInsideSeriesContext);
  if (!isInsideSeries) {
...
var SeriesSequenceRefForwardingFunction = ({ children }, _ref) => {
  ...
  return (0, import_jsx_runtime33.jsx)(IsNotInsideSeriesProvider, {
    children
  });
};
var SeriesSequence = (0, import_react73.forwardRef)(SeriesSequenceRefForwardingFunction);
var Series = (props2) => {
  const childrenValue = (0, import_react73.useMemo)(() => {
    let startFrame = 0;
    const flattenedChildren = flattenChildren(props2.children);
    return import_react73.Children.map(flattenedChildren, (child, i) => {
  ...
  return (0, import_jsx_runtime33.jsx)(IsInsideSeriesContainer, {
    children: (0, import_jsx_runtime33.jsx)(Sequence, {
      layout: "none",
      name: "<Series>",
      ...props2,
...
var Still = (props2) => {
  ...
  return import_react76.default.createElement(Composition, newProps);
};
...
var VideoForRenderingForwardFunction = ({
  ...
  const sequenceContext = (0, import_react78.useContext)(SequenceContext);
  const mediaStartsAt = useMediaStartsAt();
  const environment = useRemotionEnvironment();
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react78.useContext)(RenderAssetManager);
  const id = (0, import_react78.useMemo)(() => `video-${random(props2.src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    props2.src,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
...
var VideoForRendering = (0, import_react78.forwardRef)(VideoForRenderingForwardFunction);
var VideoForwardingFunction = (props2, ref) => {
  ...
  const { durations, setDurations } = (0, import_react77.useContext)(DurationsContext);
  ...
  const onDuration = (0, import_react77.useCallback)((src, durationInSeconds) => {
    setDurations({ type: "got-duration", durationInSeconds, src });
  }, [setDurations]);
  const onVideoFrame = (0, import_react77.useCallback)(() => {
  }, []);
  ...
  if (loop && durationFetched !== void 0) {
    if (!Number.isFinite(durationFetched)) {
      return (0, import_jsx_runtime35.jsx)(Html5Video, {
        ...propsOtherThanLoop,
        ref,
        stack,
        _remotionInternalNativeLoopPassed: true
    ...
    return (0, import_jsx_runtime35.jsx)(Loop, {
      durationInFrames: calculateMediaDuration({
        trimAfter: trimAfterValue,
      ...
      layout: "none",
      name,
      children: (0, import_jsx_runtime35.jsx)(Html5Video, {
        ...propsOtherThanLoop,
        ref,
        stack,
        _remotionInternalNativeLoopPassed: true
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime35.jsx)(VideoForRendering, {
      onDuration,
      onVideoFrame: onVideoFrame ?? null,
      ...otherProps,
      ref
...
var Html5Video = (0, import_react77.forwardRef)(VideoForwardingFunction);
